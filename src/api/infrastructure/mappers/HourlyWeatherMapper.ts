...
export class HourlyWeatherMapper {
  externalToEntity = (hourlyWeatherExternal: HourlyWeatherExternal): IHourlyWeather[] => {
    ...
    if (
      ...
      throw new AppException("Hourly weather arrays length mismatch. Api data not supported.");
    }
